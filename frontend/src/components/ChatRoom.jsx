            ...
            {messages.length === 0 ? (
              ...
              messages.map((message, index) => (
                <div
                  ...
                  className={`flex ${
                    message.anonymousId === user.anonymousId ? 'justify-end' : 'justify-start'
                  } ${message.isSystem ? 'justify-center' : ''} fade-in`}
                >
                  {message.isSystem ? (
                    // System message
                    ...
                    >
                      ...
                      <span className={`text-xs block mt-1 ${
                        message.anonymousId === user.anonymousId ? 'text-blue-100' : 'text-gray-500'
                      }`}>
                        {formatMessageTime(message.timestamp)}
                      </span>
                    </div>
